...
/* package haskell-sketchpad-0.1.0.0 */
#ifndef VERSION_haskell_sketchpad
#define VERSION_haskell_sketchpad "0.1.0.0"
#endif /* VERSION_haskell_sketchpad */
#ifndef MIN_VERSION_haskell_sketchpad
#define MIN_VERSION_haskell_sketchpad(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_sketchpad */
...
#define CURRENT_PACKAGE_KEY "haskell-sketchpad-0.1.0.0-G5TRy3nU6jn2IWkghlFyGf"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-sketchpad-0.1.0.0-G5TRy3nU6jn2IWkghlFyGf"
